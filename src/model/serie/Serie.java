...
public class Serie implements Serializable {
	...
	public Serie(String titre, Actor[] acteur, String description, Genre[] genre, int nombreSaison, int nombreEpisode, int dureeMoyenne, Date dateSortiePremiereSaison, Date dateSortieDerniereSaison, Platform[] plateforme, Boolean dejaVu, User addBy) {
		this.titre = titre;
		this.acteur = acteur;
