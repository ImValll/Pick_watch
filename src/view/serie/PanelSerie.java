...
public class PanelSerie extends JPanel {
	...
	private JPanel createSeriePanel() {
		...
		JButton searchButton = ButtonEditor.createButton(Language.getBundle().getString("serie.btnSearch"), new Color(70, 130, 180));
		searchButton.addActionListener(this::searchSerie);

		JButton addSerieButton = ButtonEditor.createButton(Language.getBundle().getString("serie.ajouterSerie"), new Color(70, 130, 180));
	...
	private void addSerie() {
		...
		int result = JOptionPane.showConfirmDialog(
				this,
				scrollPane,
				Language.getBundle().getString("serie.ajouterSerie"),
	...
	public void editSerie(Serie serie) {
		...
		int result = JOptionPane.showConfirmDialog(
				this,
				scrollPane,
				Language.getBundle().getString("serie.modifierSerie"),
				JOptionPane.OK_CANCEL_OPTION,
				JOptionPane.PLAIN_MESSAGE
		);
	...
	public void detailsSerie(Serie serie) {
		...
		final JComponent[] inputs = new JComponent[] {
				...
				new JLabel(String.valueOf(serie.getNombreSaison())),
				new JSeparator(SwingConstants.HORIZONTAL),

				new JLabel(titreStyle + Language.getBundle().getString("filtre.nombreEpisode") + "</span></html>"),
				new JLabel(String.valueOf(serie.getNombreEpisode())),
				new JSeparator(SwingConstants.HORIZONTAL),

				new JLabel(titreStyle + Language.getBundle().getString("filtre.dureeEpisode") + "</span></html>"),
				new JLabel(serie.getDureeMoyenne() + Language.getBundle().getString("filtre.min")),
				new JSeparator(SwingConstants.HORIZONTAL),
				...
				new JLabel(serie.getDejaVu() ? Language.getBundle().getString("app.oui") : Language.getBundle().getString("app.non")),
				new JSeparator(SwingConstants.HORIZONTAL),
		...
		JOptionPane.showMessageDialog(this, inputs, Language.getBundle().getString("serie.detailSerie"), JOptionPane.PLAIN_MESSAGE);
	}
