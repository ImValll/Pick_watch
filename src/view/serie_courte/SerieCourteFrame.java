...
public class SerieCourteFrame extends JFrame {
	public SerieCourteFrame() {
		...
		JButton btnTotalRandom = createButton("Choisir une série courte aléatoire", new Color(70, 130, 180));
		JButton btnFilterRandom = createButton("Appliquer des filtres au choix aléatoire", new Color(70, 130, 180));
		JButton btnShowSerieCourte = createButton("Consulter la liste des séries courtes", new Color(220, 20, 60));
